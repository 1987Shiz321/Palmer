...
u8 Params::radioCount[Params::pageCount] ={
    3, 5, 3, 5, 2, 2//menu, race, host, OTT, KO, Custom1
    //Add user radio count here

};
u8 Params::scrollerCount[Params::pageCount] ={ 1, 1, 1, 0, 2, 0 }; //menu, race, host, OTT, KO, CUSTOM1
...
u8 Params::buttonsPerPagePerRow[Params::pageCount][Params::maxRadioCount] = //first row is PulsarSettingsType, 2nd is rowIdx of radio
{
    ...
    { 2, 2, 2, 2, 3, 0 }, //Race
    { 2, 4, 2, 0, 0, 0 }, //Host
    { 2, 2, 2, 2, 2, 0 }, //OTT.ハネアイテムのOTTを有効にするには{3,3,2,2,2,0}に変更すればよい.
    { 2, 2, 0, 0, 0, 0 }, //KO
    { 2, 2, 0, 0, 0, 0 }, //Custom1
    //{}, //User
};
